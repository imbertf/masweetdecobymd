        ...
        <div className="about-container">
            ...
            <section className="introduction-container">
                ...
                <div className="introduction-wrapper">
                    <p className="introduction-wrapper-txt" data-aos="fade-up">
                        Dans la grande distribution depuis 2006, j’ai évolué au
                        traver différents métiers tels que hôtesse de caisse,
                        hôtesse d’accueil, gestionnaire approvisionnement et
                        ...
                        <br />
                        <br />
                        Etant passionnée de décoration, je me suis inscrite à la
                        formation de décoratrice d’intérieur à L’ECOLE FRANCAISE
                        dont j’ai obtenu ma certification.
                        <br /> Je suis à l’écoute de mes clients pour pouvoir
                        répondre au mieux à leurs envies et leur donner pleine
                        satisfaction tout en prenant compte de leur confort, de
                        leurs goûts, de leur mode de vie et de leurs
                        contraintes.
                    </p>
